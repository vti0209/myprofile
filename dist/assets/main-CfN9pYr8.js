/* empty css             */(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function e(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(a){if(a.ep)return;a.ep=!0;const s=e(a);fetch(a.href,s)}})();class j{static getSkeletonHTML(){return`
  ...
  `}function G(n,t,e){const i=e==="vi",a=i?"Xin chào, Tôi là "+n.name:"Hi, I'm "+n.name,s=i?"Tôi là ":"I am a ",c=t.map(l=>`
  ...
  `}function R(n,t){const e=t==="vi",i=e?n.about.title.vi:n.about.title.en,a=e?n.about.intro.vi:n.about.intro.en,s=e?n.about.subtitle.vi:n.about.subtitle.en,c=e?"Dự án":"Projects",l=e?"Năm":"Years",g=e?"Kỹ năng":"Skills",o=e?"Liên hệ":"Contact",d="CV",h=e?"Học tại":"Studying at",v=e?"Định hướng":"Career Path",r=e?"Địa điểm":"Location",m="Email",p=e?"Điện thoại":"Phone",f=e?"Trạng thái":"Status",T=e?n.details.location.vi:n.details.location.en,b=e?n.details.status.vi:n.details.status.en,$=n.about.paragraphs.map(y=>`
            ...
            <div class="details-grid">
              ...
              <div class="detail-item">
                ...
                <div class="detail-content">
                  ...
                  <strong data-vi="${n.details.location.vi}" data-en="${n.details.location.en}">${T}</strong>
                </div>
              </div>
  ...
  `}function W(n,t){const e=t==="vi",i=e?"Học vấn":"Education",a=e?"Học vấn & Bằng cấp":"Education & Diploma",s=e?"Chứng chỉ":"Certificates",c=e?"Chứng chỉ":"Certificates",l=n.education.map(o=>{const d=e?o.descriptionVi:o.descriptionEn;return`
  ...
  `}function K(n,t){const e=t==="vi",i=e?"Kỹ năng công nghệ":"Technical Skills",a=e?"Kỹ năng mềm":"Soft Skills",s=e?"Ngôn ngữ":"Languages",c=e?"Sở thích":"Interests",l=n.technical.map(h=>`
  ...
  `}class Y{static render(t,e){const{profile:i,projects:a,skills:s,experience:c,socials:l}=t,g=document.getElementById("header");g&&(g.innerHTML=U(i,l,e));const o=document.getElementById("hero");o&&(o.innerHTML=G(i,l,e));const d=document.getElementById("about");d&&(d.innerHTML=R(i,e));const h=document.getElementById("services");h&&(h.innerHTML=O(i,e));const v=document.getElementById("portfolio");v&&(v.innerHTML=X(a,e));const r=document.getElementById("resume");if(r){const f=e==="vi",T=f?"Hành trình":"Journey",b=f?"Tóm tắt quá trình học tập và kỹ năng chuyên môn.":"A summary of my educational background and technical skills.";r.innerHTML=`
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
  ...
  `).join(""),p=i.uiUxDesign.rightItems.map(u=>`
    <li><i class="bi ${u.icon}"></i> ${e?u.vi:u.en}</li>
  `).join(""),f=e?"Công cụ sử dụng":"Tools Used",T=i.tools.map(u=>`
    <span class="skill-tag"><i class="bi ${u.icon} me-1"></i> ${u.label}</span>
  `).join(""),b=e?"Xem dự án trên Figma":"View Project on Figma",$=e?"Mở trong Figma":"Open in Figma",y=i.showcaseImages.map(u=>`
